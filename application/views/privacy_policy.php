<div class='max-w-5xl container m-auto relative'>
	<div class='w-full'>
		<a href='<?php echo base_url(); ?>'>
			<p class='hover:opacity-50 pt-12 cursor-pointer'>
				< <span class='underline'>Back</span>
			</p>
		</a>
		<h1 class='mb-4 text-[40px] leading-[60px] font-bold mt-12'>
			Privacy Policy
		</h1>
		<p class='mb-4'>Last updated: January 29, 2023</p>
		<p class='mb-4'>
		...
		<h1 class='mb-4 text-[40px] leading-[60px] font-bold'>
			Interpretation and Definitions
		</h1>
		<h2 class='mb-4 text-[32px] leading-[48px] font-bold'>
			Interpretation
		</h2>
		<p class='mb-4'>
		...
		<ul>
			...
			<li class='mb-4'>
				<p class='mb-4'>
					...
					in this Agreement) refers to Social Login.
				</p>
			</li>
			<li class='mb-4'>
				<p class='mb-4'>
			...
			<li class='mb-4'>
				<p class='mb-4'>
					<strong>Website</strong> refers to Social Login, accessible from
					<a href='<?php echo base_url(); ?>' rel='noreferrer' target='_blank'>
						<?php echo base_url(); ?>
					</a>
				</p>
			</li>
		...
		<h3 class='mb-4 text-[24px] leading-[36px] font-bold'>
			Personal Data
		</h3>
		<p class='mb-4'>
		...
		<ul>
			...
			<li class='mb-4'>
				<p class='mb-4'>First name and last name</p>
			</li>
			<li class='mb-4'>
				<p class='mb-4'>Usage Data</p>
			</li>
		</ul>
		<h3 class='mb-4 text-[24px] leading-[36px] font-bold'>
			Usage Data
		...
		<h1 class='mb-4 text-[40px] leading-[60px] font-bold'>
			as to Other Websites
		</h1>
		<p class='mb-4'>
			Our Service may contain as to other websites that are not
			operated by Us. If You click on a third party a, You will be
		...
		<ul>
			<li class='mb-4'>By email: contact@salimi.my</li>
		</ul>
	</div>
</div>